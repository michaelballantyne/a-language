...
; IRModule = (HashWith :module-requires
;                      :module-require-internal-ids
;                      :module-provides
;                      :module-provide-internal-ids
;                      :block-defs)
; :module-requires :: (ListOf String)
; :module-require-internal-ids :: (ListOf String)
...
; IRDef = (HashWith :id :rhs)
; :block-defs :: (ListOf IRDef)

; IRExp = (OneOf IRLiteral IRLocalRef IRModuleRef IRApp IRIf IRFn IRLoop IRBlock IRRecur)

; IRLiteral = (HashWith :literal)
; :literal :: LiteralValue
; LiteralVal = (OneOf Boolean String Number)

; IRLocalRef = (HashWith :local-ref)
; :local-ref :: String

; IRModuleRef = (HashWith :module-ref-sym :module-ref-field)
; :module-ref-sym :: String
; :module-ref-field :: String

; IRApp = (HashWith :app-exps)
; :app-exps :: (ListOf IRExp)

; IRIf = (HashWith :if-c :if-t :if-e)
; :if-c :: IRExp
; :if-t :: IRExp
; :if-e :: IRExp

; IRFn = (HashWith :fn-temps :fn-args :block-defs :block-ret)
; :fn-temps :: (ListOf String)
; :fn-args :: (ListOf String)
; :block-ref :: IRExp

; IRLoop = (HashWith :loop-vars :loop-inits :block-defs :block-ret)
; :loop-vars :: (ListOf String)
; :loop-inits :: (ListOf IRExp)

; IRBlock = (HashWith :block-defs :block-ret)

; IRRecur = (HashWith :recur-exps :recur-temps)
