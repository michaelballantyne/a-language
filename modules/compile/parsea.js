  ...
  (fn (forms env)
    (if (= 0 (size forms))
      ...
      (block
        ...
        (def parsed-defs (parse-defs (reverse (rest forms)) env))
...
(def parse-module
  (fn (sexp runner)
    ...
    (def _2 (if (not (valid-reqprov? provide-form "provide"))
              (module-syntax-error)
              null))
    ...
    (def _3 (if (not (subset provides (get parsed-defs :surface-def-ids)))
